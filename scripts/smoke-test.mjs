...
assert.match(styles, /\.mini-surf-fin,\s*\.mini-mountain,\s*\.mini-baseball,\s*\.mini-lacrosse-stick\s*\{[^}]*position:\s*absolute[^}]*translate:\s*-50% -50%/s);
...
assert.match(styles, /\.mini-surf-board/);
assert.match(styles, /\.mini-skis/);
